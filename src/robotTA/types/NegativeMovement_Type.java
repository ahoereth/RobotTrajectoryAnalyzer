 ...
 * @generated */
public class NegativeMovement_Type extends Annotation_Type {
  /** @generated 
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (NegativeMovement_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = NegativeMovement_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new NegativeMovement(addr, NegativeMovement_Type.this);
  			   NegativeMovement_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new NegativeMovement(addr, NegativeMovement_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = NegativeMovement.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("robotTA.types.NegativeMovement");
  ...
  public String getJointName(int addr) {
      ...
      jcas.throwFeatMissing("jointName", "robotTA.types.NegativeMovement");
  ...
  public double getStartPosition(int addr) {
      ...
      jcas.throwFeatMissing("startPosition", "robotTA.types.NegativeMovement");
  ...
  public double getEndPosition(int addr) {
      ...
      jcas.throwFeatMissing("endPosition", "robotTA.types.NegativeMovement");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public NegativeMovement_Type(JCas jcas, Type casType) {
    super(jcas, casType);
